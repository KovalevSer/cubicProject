...
/**
 * TaskCommentSearch represents the model behind the search form about `app\modules\cubicProject\models\TaskComment`.
 */
class TaskCommentSearch extends TaskComment
{
    ...
    {
        return [
            [['id', 'taskID', 'userID'], 'integer'],
            [['message', 'postedTime'], 'safe'],
        ];
    }
